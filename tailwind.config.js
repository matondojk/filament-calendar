  ...
  theme: {
    extend: {
        colors: {
            ...
            gray: {
                50: 'rgba(var(--gray-50, 250, 250, 250), <alpha-value>)',
                100: 'rgba(var(--gray-100, 244, 244, 245), <alpha-value>)',
                200: 'rgba(var(--gray-200, 228, 228, 231), <alpha-value>)',
                300: 'rgba(var(--gray-300, 212, 212, 216), <alpha-value>)',
                400: 'rgba(var(--gray-400, 161, 161, 170), <alpha-value>)',
                500: 'rgba(var(--gray-500, 113, 113, 122), <alpha-value>)',
                600: 'rgba(var(--gray-600, 82, 82, 91), <alpha-value>)',
                700: 'rgba(var(--gray-700, 63, 63, 70), <alpha-value>)',
                800: 'rgba(var(--gray-800, 39, 39, 42), <alpha-value>)',
                900: 'rgba(var(--gray-900, 24, 24, 27), <alpha-value>)',
                950: 'rgba(var(--gray-950, 9, 9, 11), <alpha-value>)',
            },
        }
    },
  },
